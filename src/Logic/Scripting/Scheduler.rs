...
pub struct Scheduler {
    commands: Arc<Mutex<HashMap<String, Box<dyn Fn() -> bool + Send>>>>,
...
impl Scheduler {
    ...
    pub fn register_commands(&mut self, new_commands: HashMap<String, Box<dyn Fn() -> bool + Send>>) {
...
fn run_block(
    commands: &HashMap<String, Box<dyn Fn() -> bool + Send>>,
    code: &Code,
) {
